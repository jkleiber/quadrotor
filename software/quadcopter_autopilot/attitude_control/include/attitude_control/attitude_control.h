    ...
    AttitudeControl(const float control_period)
        : roll_pid_(kleiber_control::PidParameters{.kp = kRollKp,
          ...
          yaw_pid_(kleiber_control::PidParameters{.kp = kYawKp,
                                                  ...
                                                  .leak_factor = kYawLeak},
                   control_period),
          roll_rate_pid_(
              kleiber_control::PidParameters{
                  .kp = kRollRateKp,
                  .ki = kRollRateKi,
                  .kd = kRollRateKd,
                  .kf = kRollRateKf,
                  ...
                  .integrator_min = -kRollRateIntegralLimit,
                  .integrator_max = kRollRateIntegralLimit,
                  .leak_factor = kRollRateLeak},
              control_period),
          pitch_rate_pid_(
              kleiber_control::PidParameters{
                  .kp = kPitchRateKp,
                  ...
                  .min_out = kRatePIDLower,
                  .max_out = kRatePIDUpper,
                  .integrator_min = -kPitchRateIntegralLimit,
                  .integrator_max = kPitchRateIntegralLimit,
                  .leak_factor = kPitchRateLeak},
              control_period),
          yaw_rate_pid_(
              kleiber_control::PidParameters{
                  .kp = kYawRateKp,
                  ...
                  .min_out = kRatePIDLower,
                  .max_out = kRatePIDUpper,
                  .integrator_min = -kYawRateIntegralLimit,
                  .integrator_max = kYawRateIntegralLimit,
                  .leak_factor = kYawRateLeak},
              control_period),
          mode_(Rate)
    {
    }
